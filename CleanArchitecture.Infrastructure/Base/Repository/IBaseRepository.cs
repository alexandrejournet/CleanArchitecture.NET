...
namespace CleanArchitecture.Infrastructure.Base.Repository
{
    public interface IBaseRepository<T> where T : class
    {
        ...
        Task<TEntity?> GetBy<TEntity>(string query, ICollection<DbParameter> parameters) where TEntity : class;
        ...
        Task<ICollection<T>> GetAllAsync(string query);
        ...
        Task<ICollection<T>> PageAllAsync(Page page);
        ...
        IQueryable<T> PageAllQueryable(Page page);
        ...
        #region AutoMapper
        Task<List<DTO>> GetAllAsyncDto<DTO>() where DTO : class;
        Task<List<DTO>> GetAllAsyncDto<DTO>(Expression<Func<T, bool>> where) where DTO : class;
        Task<List<DTO>> GetAllAsyncDto<DTO>(Expression<Func<T, bool>> where, Page pageRequest) where DTO : class;
        Task<List<DTO>> GetAllAsyncDto<DTO>(Page pageRequest) where DTO : class;
        Task<List<DTO>> GetAllAsyncDto<DTO>(string query, List<DbParameter> parameters, Page pageRequest) where DTO : class;
        IQueryable<DTO> GetAllQueryableDto<DTO>() where DTO : class;
        IQueryable<DTO> GetAllQueryableDto<DTO>(Expression<Func<T, bool>> where) where DTO : class;
        IQueryable<DTO> GetAllQueryableDto<DTO>(Expression<Func<T, bool>> where, Page pageRequest) where DTO : class;
        IQueryable<DTO> GetAllQueryableDto<DTO>(Page pageRequest) where DTO : class;
        IQueryable<DTO> GetAllQueryableDto<DTO>(string query, List<DbParameter> parameters, Page pageRequest) where DTO : class;
